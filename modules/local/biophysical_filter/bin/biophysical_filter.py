...
"""
Compute biophysical properties for candidate protein sequences.

This module annotates each candidate with absolute sequence descriptors and
delta values relative to the first sequence in the input CSV, used as WT
reference.
